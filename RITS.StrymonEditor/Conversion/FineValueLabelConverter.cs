...
namespace RITS.StrymonEditor
{
    ...
    public class FineValueLabelConverter:IValueLabelConverter
    {
        ...
        public string ValueToLabel(int value)
        {
            ...
            {
                if (Globals.IsBPMModeActive) return Globals.ConvertMilliHzToBPM(_parameter.FineValue).ToString() + " bpm";
            ...
            {
                if (Globals.IsBPMModeActive) return Globals.ConvertMillisecondsToBPM(_parameter.FineValue).ToString() + " bpm";
