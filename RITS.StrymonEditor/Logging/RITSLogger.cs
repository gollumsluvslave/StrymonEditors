...
namespace RITS.StrymonEditor.Logging
{
    ...
    /// </summary>
    public sealed class RITSLogger : ILogger
    {
        #region .ctor
        public RITSLogger() : this(true) {}

        /// <summary>
        /// Initializes a new instance of the <see cref="RITSLogger" /> class.
        /// </summary>
        /// <param name="logMethodEntered">Whether to log that the calling method was entered.</param>
        public RITSLogger(bool logMethodEntered)
        {
            try
            {                
